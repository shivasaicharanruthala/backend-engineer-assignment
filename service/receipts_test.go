...
// TestServiceInsert_Success: In these tests, we haven't used mock interfaces for the Insert method from the store layer
// because we want to verify how the total points are calculated by actually fetching from the store using Get method.
