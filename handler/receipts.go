...
import (
	...
	"github/shivasaicharanruthala/backend-engineer-assignment/responder"
...
// It reads and unmarshal the request body, then inserts the receipt through the service layer.
